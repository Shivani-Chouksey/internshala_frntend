...
//   console.log(employe && employe.avatar.url)
...
//     event.preventDefault();
//     dispatch(asyncSigninemploye(signData));
//   };
        ...
        >
          <div className="">
            ...
            <img
              ...
              src="https://internshala.com/static/images/registration/employe_new/underline_d.svg"
              alt=""
            />
          </div>
          ...
          <div className="rounded-circle mx-auto my-3" style={{width:"100px",height:"100px",overflow:"hidden"}}>
            <img  src={employe && employe.organizationlogo.url} alt="" style={{width:"100%",height:"100%",objectFit:"cover"}} />
          </div>
