...
export const asyncAddRducaton = (edu) => async (dispatch, getState) => {
  try {
    ...
    await dispatch(fetchCurrentStudent());
    return data;
    toast.success("Add Education  Successfully", { position: "top-center" });
...
export const asyncEditEducaton = (id,edu) => async (dispatch, getState) => {
  try {
    ...
    await dispatch(fetchCurrentStudent());
    return data;
    toast.success("Education Edit Successfully", { position: "top-center" });
...
export const asyncDeletEducaton = (id) => async (dispatch, getState) => {
  try {
    ...
    await dispatch(fetchCurrentStudent());
    return data;
    toast.success(" Education Delete  Successfully", { position: "top-center" });
